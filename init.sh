...
# Your ~/.bash folder.
[ -z "$SHBUNDLER_HOME" ]        && export SHBUNDLER_HOME="$HOME/.bash"
...
[ -z "$SHBUNDLER_ROOT" ]        && export SHBUNDLER_ROOT="$BUNDLE_ROOT"
[ -z "$SHBUNDLER_ROOT" ]        && export SHBUNDLER_ROOT="$SHBUNDLER_HOME/bundle/shellbundler"
...
[ -z "$SHBUNDLER_LOADED" ]      && export SHBUNDLER_LOADED=":"
[ -z "$SHBUNDLER_CACHE_PATH" ]  && export SHBUNDLER_CACHE_PATH="$HOME/.cache/shellbundler"
